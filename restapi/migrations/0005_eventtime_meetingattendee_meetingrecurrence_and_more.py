    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month_week', models.IntegerField(blank=True, choices=[(1, 'First'), (2, 'Second'), (3, 'Third'), (4, 'Fourth'), (5, 'Last')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('working_days', models.IntegerField(verbose_name=models.IntegerField(blank=True, choices=[(0, 'Monday'), (1, 'Tuesday'), (2, 'Wednesday'), (3, 'Thursday'), (4, 'Friday'), (5, 'Saturday'), (6, 'Sunday')], null=True))),
        ...
        migrations.AddField(
            ...
            name='meeting',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restapi.meeting'),
        ),
        migrations.AddField(
            model_name='meetingtask',
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restapi.task'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='meeting',
            name='recurrence',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='restapi.meetingrecurrence'),
        ),
